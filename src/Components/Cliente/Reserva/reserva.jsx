...
import { TextField, Button, Box, IconButton, MenuItem, Table, TableBody, TableCell, TableRow, Grid } from '@mui/material';
  ...
  <div style={containerStyle}>
     ...
     <form onSubmit={handleSubmit}>
       <Grid container spacing={2}>
         ...
         <Grid item xs={12}>
           <Button onClick={addReservation} style={{ marginTop: "30px", backgroundColor: "#36A2EB", boxShadow: "none", border: "solid #36A2EB", width:"100%" }} variant="contained" fullWidth>
             Agregar Reservación
           </Button>
         </Grid>
         <Grid item xs={12}>
           <Button style={{ marginTop: "30px", backgroundColor: "red", boxShadow: "none", border: "solid red", width:"100%" }} type="submit" variant="contained" disabled={!isEnabled} fullWidth>
             Reservar
           </Button>
         </Grid>
       </Grid>
